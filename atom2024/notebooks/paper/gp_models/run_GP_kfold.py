...
if __name__=='__main__': 
    gp_kfold_results = "/Users/jayceepang/msse/capstone/atom2024/atom2024/notebooks/paper/results/gp_kfold_results/"
    datapath = '/Users/jayceepang/msse/capstone/atom2024/atom2024/notebooks/paper/datasets/80train_20test/k_fold/validation/'
    ...
    all_train.to_csv(f'{gp_kfold_results}GP_train_results_all_NEK_kfold_val.csv', index=False) 
    all_test.to_csv(f'{gp_kfold_results}GP_test_results_all_NEK_kfold_val.csv', index=False)                 
