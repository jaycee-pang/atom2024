            ...
            for k in samplings: 
                for l in model_types: 
                    ...
                    with open(f'{model_name}', 'wb') as f: 
                        pickle.dump(grid_search, f) # started June 13 1:06 pm, 1st moe scaled rf done 2:15 pm
                        # 3rd: before 2:53 pm
                        # binding mfp started before 3:49 pm
                        # inhibition start: June 13 before 5:37 pm
                        # finished 11:28 pm